...
This model does not include genetic effects
...
path = './covid-analysis/'
features_file = path + 'feature-files/hcov_oct2020_bestTree_regionOnly_features.csv'
...
file_name = "covid_spaceXTimeByRegion_Oct2020_regionEffectsOnly_estimates.csv"
folder = "./"
...
line_fit_df.to_csv("covid_spaceXTimeByRegion_Oct2020_regionEffectsOnly_lineFitEstimates.csv",index=False)
...
if profile:
    ...
    file_name = "covid_spaceXTimeByRegion_Oct2020_siteEffects_rhoSampling_allMonthlyIntervals_likeProfiles.csv"
    folder = "./"
